...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col bg-sidebar text-sidebar-foreground min-h-0 overflow-hidden">
      ...
      <nav className="flex-1 space-y-4 overflow-y-auto p-4 custom-scrollbar min-h-0">
  ...
  return (
    <div className="flex h-screen w-full bg-background text-foreground overflow-hidden">
      {/* Desktop Sidebar */}
      <aside className="hidden w-64 flex-col border-r border-sidebar-border bg-sidebar lg:flex shadow-sm min-h-0 shrink-0">
        <SidebarContent />
      </aside>
      ...
      <div className="flex flex-1 flex-col min-h-0 overflow-hidden">
        ...
        {/* Main */}
        <main className="flex-1 overflow-y-auto bg-background p-3 sm:p-4 lg:p-8 custom-scrollbar min-h-0">
