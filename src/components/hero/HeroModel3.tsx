                ...
                <div className="order-2 lg:order-1 space-y-8 relative z-10">
                  ...
                  <div className="flex gap-4 pt-4">
                    <Link to={`/campanha/${campaign.id}`} className="flex-1">
                      <Button size="lg" className="w-full h-16 rounded-2xl font-black uppercase italic tracking-widest gap-2 glow-primary border-light-path border-light-always text-base border-light-path border-[#22c55e]/30 relative z-10">
