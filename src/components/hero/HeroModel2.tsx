              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 pt-8">
                  <Link to={`/campanha/${campaign.id}`}>
                    <Button size="lg" className="h-20 rounded-[2rem] px-12 gap-4 text-xl font-black uppercase italic tracking-widest glow-primary border-light-path border-light-always hover:scale-105 transition-transform shadow-[0_0_50px_rgba(var(--primary-rgb),0.4)] border-light-path border-[#22c55e]/30 relative z-10">
