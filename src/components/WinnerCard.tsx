...
const WinnerCard = ({ winner, index }: WinnerCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-sm hover:border-primary/30 hover:shadow-md transition-all group border-light-path border-[#22c55e]/20"
    >
      {/* Background Icon */}
