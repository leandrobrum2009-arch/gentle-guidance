 ...
 import { 
   ...
   ExternalLink, ShieldCheck, Loader2, QrCode
 } from "lucide-react";
               ...
               <Card className="border-primary/50 bg-primary/5 shadow-xl ring-1 ring-primary/20 overflow-hidden">
                 <CardContent className="p-8 text-center space-y-6">
                   ...
                   <div className="space-y-2">
                     ...
                     <p className="text-muted-foreground">Você já está participando do sorteio. Boa sorte!</p>
                   </div>
             ...
             <Card className="border-border/50 bg-card/50 backdrop-blur-sm sticky top-24">
               ...
               <CardContent className="space-y-4">
                 <div className="space-y-1">
                   ...
                   <p className="text-[10px] text-muted-foreground">{order.quantity} x R$ {Number(order.campaigns?.ticket_price).toFixed(2)}</p>
                 </div>
                 <Separator />
