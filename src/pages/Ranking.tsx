        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/60">Hall da Fama</span>
            </div>
            ...
            <p className="text-muted-foreground uppercase font-black tracking-[0.3em] text-[10px] md:text-xs max-w-xl mx-auto leading-relaxed">
              Os maiores jogadores e colecionadores de pontos da plataforma! <span className="text-white">Alcance o topo</span> e ganhe recompensas exclusivas.
            </p>
          </motion.div>
          ...
          <div className="bg-[#0d0d0f]/50 border border-white/5 rounded-[40px] p-6 md:p-10 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
