            ...
            <div className="prose prose-zinc dark:prose-invert max-w-none">
              ...
              <div className="grid gap-12">
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed pl-13">
                    <p>
                      Ao ser contemplado em qualquer premiação promovida pela GF Customizados — incluindo, mas não se limitando a prêmio principal, prêmios instantâneos, cotas premiadas, roletas, raspadinhas, caixinhas, presentes ou quaisquer outras dinâmicas promocionais — o ganhador obriga-se a enviar um vídeo de depoimento, conforme orientações fornecidas pela equipe da GF Customizados.
                    </p>
